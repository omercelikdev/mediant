...
using Mediant.Analyzers;

namespace Mediant.Analyzers.Tests;
        ...
        foreach (var anchor in new[]
                 {
                     ...
                     typeof(Mediant.Behaviors.Attributes.CacheableAttribute).Assembly.Location,
                     typeof(Mediant.AspNetCore.Attributes.HttpEndpointAttribute).Assembly.Location,
                 })
        {
