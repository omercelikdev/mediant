...
namespace Mediant.UnitTests.PublicApi;
...
public class PublicApiTests
{
    ...
    {
        yield return new object[] { typeof(Mediant.Abstractions.IMediator).Assembly };
        yield return new object[] { typeof(Mediant.Behaviors.Behaviors.CachingBehavior<,>).Assembly };
        yield return new object[] { typeof(Mediant.AspNetCore.Mapping.EndpointMapper).Assembly };
        yield return new object[] { typeof(Mediant.FluentValidation.ValidationBehavior<,>).Assembly };
    }
    ...
    public void Public_Api_Has_Not_Changed(Assembly assembly)
    {
        ...
        if (!File.Exists(approvedPath))
        {
            ...
            throw new Xunit.Sdk.XunitException(
                ...
                $"'{AppContext.BaseDirectory}'. Review it and copy it to 'tests/Mediant.UnitTests/PublicApi/{name}.approved.txt'.");
        }
